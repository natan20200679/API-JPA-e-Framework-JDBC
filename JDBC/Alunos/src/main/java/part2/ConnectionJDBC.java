...
public class ConnectionJDBC {
    public static void main(String[] args) {
        ...
        //Carregar a classe específica de implementação do driver na memória da JVM.
        // (A partir da versão JDBC 4 não é mais necessário!!!)
        //Class.forName("com.mysql.jdbc.Driver");

        // 4 - Criar conexão usando o DriverManager, passando como parâmetros a string de conexão,
