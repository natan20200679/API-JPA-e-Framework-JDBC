...
public class ConnectionFactory {
    ...
    public static Connection getConnection() {
        ...
        // 2 - Carregar arquivo de propriedades para pegar parâmetros necessários para se comunicar
        ...
        try (InputStream input = ConnectionFactory.class.getClassLoader()
            ...
            // 5 - Criar conexão usando o DriverManager, passando como parâmetros a string de conexão,
